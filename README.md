...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    React JS is a JavaScript library for building user interfaces. It is a small package that can be used to build big, fast apps.

- [ ] What does it mean to _think_ in react?
    Thinking in React is breaking the UI down into Component Hierarchies, like a puzzle, trying to see what goes in what.

- [ ] Describe state.
    State is where data is stored.

- [ ] Describe props.
    Props are properties/data that can be passed to components to help build the UI.
